...
export function printHtml(title: string, bodyHtml: string) {
  ...
  <style>
    * { box-sizing: border-box; }
    ...
    .head { display: flex; justify-content: space-between; align-items: flex-start; border-bottom: 3px solid #1ea75f; padding-bottom: 12px; margin-bottom: 18px; }
    .logo { display:flex; align-items:center; gap:10px; }
    .logo-badge { width:42px; height:42px; border-radius:10px; background:#1ea75f; color:#fff; display:flex; align-items:center; justify-content:center; font-weight:800; font-size:20px; }
    ...
    .total-box { margin-top: 14px; border: 2px solid #1ea75f; border-radius: 10px; padding: 12px 16px; display: inline-block; font-size: 16px; font-weight: 700; }
